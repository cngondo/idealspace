...
class ApartmentsControllerTest < ActionController::TestCase
  ...
  test "should create apartment" do
    assert_difference('Apartment.count') do
      post :create, apartment: { residence: @apartment.residence, street: @apartment.street, type: @apartment.type }
    end
  ...
  test "should update apartment" do
    patch :update, id: @apartment, apartment: { residence: @apartment.residence, street: @apartment.street, type: @apartment.type }
    assert_redirected_to apartment_path(assigns(:apartment))
  end
